...
$(package)_patches=1.0.15-pubkey-validation.diff 1.0.15-signature-validation.diff 1.0.20-immintrin-conflict.diff 1.0.22-evex512-fix.patch
...
define $(package)_preprocess_cmds
  ...
  patch -p1 < $($(package)_patch_dir)/1.0.22-evex512-fix.patch && \
