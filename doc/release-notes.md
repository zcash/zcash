...
Additional information relating to running on low-memory systems can be found here: [reducing-memory-usage.md](https://github.com/sodatoken/sodatoken/BinaryOmen/sodatoken2/blob/master/doc/reducing-memory-usage.md).
