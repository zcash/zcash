...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "SodaToken" in FormatException()
...
Simon (91):
      ...
      Reduce use of global psodatokenParams with private member variable
      Revert "Reduce use of global psodatokenParams with private member variable"
      Replace sodatokenParams_ with global.
