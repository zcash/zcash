...
Jack Grigg (43):
      ...
      Move serialized SodaToken address length constants into sodatoken/Address.hpp
...
Jay Graber (4):
      Link to sodatoken.org on security-warnings.md
...
Kevin Gallagher (5):
      ...
      Updates dns.testnet.sodatoken.org -> dnsseed.testnet.sodatoken.org
