...
Jay Graber (17):
      ...
      Refer to SodaToken wiki in INSTALL
      Rm bitcoin logo
      Rm build-unix.md, to keep single copy of build instructions for SodaToken on github wiki
      Rm Bitcoin-specific documentation
      Add note that document is not updated for SodaToken to translation policy
      Rm doc for disabled REST interface
      Change alpha to beta testnet, add sodatoken hidden service
      Improve documentation on connecting to sodatoken hidden server
      Improve documentation on connecting to sodatoken hidden server
      Update tor.md
...
Kevin Gallagher (24):
      ...
      Adds json_test_vectors.h to sodatoken_gtest_SOURCES
      Adds additional licenses to Debian copyright file
      Updates SodaToken Core developers -> SodaToken developers
...
Simon (11):
      ...
      Reorder gtests in sodatoken-gtest.
