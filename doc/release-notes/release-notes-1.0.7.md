...
Jack Grigg (11):
      ...
      Adjust gen-manpages.sh for SodaToken, use in Debian builds
      Regenerate and collate SodaToken manpages, delete Bitcoin ones
      Update release process with gen-manpages.sh
      Adjust blockheaderToJSON() for SodaToken block header
      Adjust fundrawtransaction RPC test for SodaToken
      Re-encode t-addrs in disablewallet.py with SodaToken prefixes
