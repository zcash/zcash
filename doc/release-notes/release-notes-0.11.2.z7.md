...
bitcartel (15):
      ...
      Update URL for sodatoken alert IDs.
...
Taylor Hornby (17):
      ...
      Rename zerocash to sodatoken in some places.
      Remove references to libzerocash in .gitignore
      Rename qa/zerocash to qa/sodatoken in Makefile.am
      Rename zerocash_packages to sodatoken_packages in packages.mk
