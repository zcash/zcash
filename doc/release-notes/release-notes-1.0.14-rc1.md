...
[the SodaToken protocol spec](https://github.com/sodatoken/zips/blob/master/protocol/protocol.pdf),
...
- **Caution:** for z-addresses, these balances will **not** be accurate if any
  ...
  (e.g. [#2542](https://github.com/sodatoken/sodatoken/BinaryOmen/sodatoken2/issues/2542)).
...
Jack Grigg (36):
      ...
      build: Split hardening/fPIE options out in SodaToken-specific binaries
      Change --enable-werror to apply to all warnings, use it in build.sh
      Move SodaToken flags into configure.ac
      ViewingKey -> ReceivingKey per sodatoken/zips#117
      ...
      Add watch-only support to SodaToken RPC methods
...
syd (13):
      ...
      Rename bash completion files so that they refer to sodatoken and not bitcoin.
