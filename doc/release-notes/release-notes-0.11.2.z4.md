...
Alfie John (1):
      Rename libzerocash to libsodatoken
...
Jack Grigg (21):
      ...
      Add SodaToken revision to version strings
      Bitcoin -> SodaToken in version and help text
      Add SodaToken Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-sodatoken`` correctly runs the ``sodatoken-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the SodaToken build.
