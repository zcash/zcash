...
SodaToken has been subjected to a formal third-party security review. For security
announcements, audit results and other general security information, see
https://sodatoken.org/support/security.html
...
This implementation of SodaToken is not resistant to side-channel attacks. You
should assume (even unprivileged) users who are running on the hardware, or who
are physically near the hardware, that your `sodatokend` process is running on will
be able to:
...
unprivileged) on the hardware your `sodatokend` process runs on until these
...
in [issue #826](https://github.com/sodatoken/sodatoken/BinaryOmen/sodatoken2/issues/826), and believe that we
