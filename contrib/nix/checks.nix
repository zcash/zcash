...
{
  cargo-patches = runCommand "cargo-patches" {
    inherit src;
  } ''
  ...
  include-guards = runCommand "include-guards" {
    inherit src;
  } ''
  ...
  python-utf8-encoding = runCommand "python-utf8-encoding" {
    inherit src;
  } ''
