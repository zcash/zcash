...
DOCKERAPP_GID=$2        # This must be a GID, not a "name"!

# Get KEY and ID from AWS, e.g.:
# https://console.aws.amazon.com/iam/home?region=us-east-2#/security_credentials
AWS_ACCESS_KEY_ID=$3    # This is specific to your AWS login (see above)
AWS_SECRET_KEY=$4       # This is specific to your AWS login (see above)
...
SSH_PUBKEY=$5           # Once your AMI is launced (e.g. as an EC2) you can use this keypair to ssh
IMAGE_SPECIFICATION=$6  # e.g. gitlabrunner/specification.json

PWD=$(pwd)

docker run --user=$DOCKERAPP_UID:$DOCKERAPP_GID -v $PWD:$PWD -v $PWD/tmp:/tmp -w $PWD \
