...
class OperationFailed(Exception):
    ...
    def __init__(self, opid: str, error: str) -> None:
        self.opid = opid
        self.error = error
...
class OperationTimeout(Exception):
    ...
    def __init__(self, opid: str, elapsed: float) -> None:
        self.opid = opid
...
class ZcashRPC:
    ...
    def __init__(self, rpcport: int = 18443, rpcuser: str = "test",
                 rpcpassword: str = "test", rpchost: str = "127.0.0.1") -> None:
        self.url = f"http://{rpchost}:{rpcport}"
        self.rpcuser = rpcuser
        self.rpcpassword = rpcpassword
        self._request_id = 0

    def call(self, method: str, *params: Any, timeout: int = 300) -> Any:
        """
    ...
    def wait_for_ready(self, timeout: int = 300, poll_interval: int = 2) -> dict:
        """
    ...
    def wait_for_operation(self, opid: str, timeout: int = 600, poll_interval: int = 1) -> dict:
        """
    ...
    def z_getnewaddress(self, addr_type: str | None = None) -> str:
        """
    ...
    def z_getaddressforaccount(self, account: int,
                               receiver_types: list[str] | None = None,
                               diversifier_index: int | None = None) -> dict:
        """
    ...
    def z_shieldcoinbase(self, from_address: str, to_address: str,
                         fee: float | None = None, limit: int | None = None) -> dict:
        """
    ...
    def z_sendmany(self, from_address: str, recipients: list[dict],
                   minconf: int | None = None, fee: float | None = None,
                   privacy_policy: str | None = None) -> str:
        """
    ...
    def z_gettotalbalance(self, minconf: int = 1) -> dict:
        """
    ...
    def z_getbalanceforaccount(self, account: int, minconf: int = 1) -> dict:
        """
    ...
    def z_getbalance(self, address: str, minconf: int = 1) -> Any:
    ...
    def listunspent(self, minconf: int = 1, maxconf: int = 9999999,
                    addresses: list[str] | None = None) -> list:
        """
    ...
    def z_listunspent(self, minconf: int = 1, maxconf: int = 9999999,
    ...
    def z_listreceivedbyaddress(self, address: str, minconf: int = 1) -> list:
    ...
    def z_exportviewingkey(self, address: str) -> str:
        """
    ...
    def getaddressesbyaccount(self, account: str = "") -> list:
        """List all transparent addresses (deprecated in newer versions)."""
        return self.call("getaddressesbyaccount", account)

    # -- Key import --

    def importprivkey(self, privkey: str, label: str = "", rescan: bool = False) -> Any:
    ...
    def importaddress(self, address_or_script: str, label: str = "",
                      rescan: bool = False, p2sh: bool = False) -> Any:
    ...
    def importpubkey(self, pubkey_hex: str, label: str = "", rescan: bool = False) -> Any:
    ...
    def z_importkey(self, spending_key: str, rescan: str = "no", start_height: int = 0) -> Any:
    ...
    def z_importviewingkey(self, viewing_key: str, rescan: str = "no", start_height: int = 0) -> Any:
