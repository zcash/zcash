...
# This script tests that the package mirror at https://sodatoken.org/depends-sources/
# contains all of the packages required to build this version of SodaToken.
#
# This script assumes you've just built SodaToken, and that as a result of that
...
MIRROR_URL_DIR="https://sodatoken.org/depends-sources/"
