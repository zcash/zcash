# mininode.py - Zcash P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a zcash node
...
# Objects that map to zcashd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in zcashd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", protocol_version=SAPLING_PROTO_VERSION):
        ...
        print('MiniNode: Connecting to Zcash Node IP # ' + dstaddr + ':' \
