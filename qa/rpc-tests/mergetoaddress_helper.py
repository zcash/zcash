...
class MergeToAddressHelper:
    ...
    def run_test(self, test):
        ...
        wait_and_assert_operationid_status(test.nodes[0], result['opid'])
        blockhash = test.genreate_synced(1, 1)
