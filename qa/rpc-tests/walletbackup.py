...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[1].getbalance(), Decimal(self._coin))
        assert_equal(self.nodes[2].getbalance(), Decimal(self._coin))
        ...
        # 114 are mature, so the sum of all wallets should be 114 * 12.5
        assert_equal(total, 114*Decimal(self._coin))
