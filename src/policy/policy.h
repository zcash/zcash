...
/** Default for -blockshieldedsize, prioritised space for shielded transactions **/
static const unsigned int DEFAULT_BLOCK_SHIELDED_SIZE = DEFAULT_BLOCK_MAX_SIZE / 2;
...
BOOST_STATIC_ASSERT(DEFAULT_BLOCK_SHIELDED_SIZE <= DEFAULT_BLOCK_MAX_SIZE);
