...
bool CWalletDB::WriteCryptedZKey(const libsodatoken::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libsodatoken::PaymentAddress& addr, const libsodatoken::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
...
bool CWalletDB::WriteViewingKey(const libsodatoken::ViewingKey &vk)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("vkey"), vk), '1');
}

bool CWalletDB::EraseViewingKey(const libsodatoken::ViewingKey &vk)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libsodatoken::PaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 rkValue;
            ssValue >> rkValue;
            libsodatoken::ReceivingKey rk(rkValue);
