...

    {
        ...
        BOOST_FOREACH(const MasterKeyMap::value_type& pMasterKey, mapMasterKeys)
        {
            if(!crypter.SetKeyFromPassphrase(
                    ...
                    pMasterKey.second.vchOtherDerivationParameters))
                return false;
...

    {
        ...
        BOOST_FOREACH(MasterKeyMap::value_type& pMasterKey, mapMasterKeys)
        {
            ...
            if (CCryptoKeyStore::Unlock(vMasterKey))
            {
                ...
                if (pMasterKey.second.nDeriveIterations < crypto_pwhash_OPSLIMIT_INTERACTIVE)
                    pMasterKey.second.nDeriveIterations = crypto_pwhash_OPSLIMIT_INTERACTIVE;
...
bool CWallet::EncryptWallet(const SecureString& strWalletPassphrase)
{
    ...
    crypter.SetKeyFromPassphrase(
            ...
            kMasterKey.vchOtherDerivationParameters);
    kMasterKey.nDeriveIterations = crypto_pwhash_OPSLIMIT_INTERACTIVE * 100 / ((double)(GetTimeMillis() - nStartTime));
    ...
    if (kMasterKey.nDeriveIterations < crypto_pwhash_OPSLIMIT_INTERACTIVE)
        kMasterKey.nDeriveIterations = crypto_pwhash_OPSLIMIT_INTERACTIVE;
