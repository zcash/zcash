...
public:
    CMainParams() {
         ...
         * >>> 'ZcashPlus' + blake2s(b'CNN 21/December/2017 Despite Haley threat, UN votes to condemn Trump's Jerusalem decision').hexdigest()
         */
        const char* pszTimestamp = "ZcashPlus85bbac659bc1df3ebf22d3a8d3b51b6a66fb16e9783f98465946dbb5d5f6240e";
        ...
        assert(consensus.hashGenesisBlock == uint256S("925dde166a8f69235293024b6004d2a8e8ca634427063097bc72f61f34327082"));
        assert(genesis.hashMerkleRoot == uint256S("e26dc357b3cfdc99d4f7b4f8e132ec8b7dbd83e145307e40ac5f8413192cbe9d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("z.cash", "dnsseed.z.cash")); // ZcashPlus
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("e5a3a8207c4dc474475c91ac86a733058338c0d7f65edae4ecdb38232e13e891"));
        assert(genesis.hashMerkleRoot == uint256S("e26dc357b3cfdc99d4f7b4f8e132ec8b7dbd83e145307e40ac5f8413192cbe9d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("zcashplus.org", "dnsseed-testnet.zcashplus.org")); // Zcash
...
public:
    CRegTestParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("d4aeffa42ceddacba305df4a70e91ed3c2ab648bd6097d6fd12b521f5df8d064"));
        nPruneAfterHeight = 1000;
        ...
        checkpointData = (Checkpoints::CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("d4aeffa42ceddacba305df4a70e91ed3c2ab648bd6097d6fd12b521f5df8d064")),
            genesis.nTime,
            0,
            0
        };
