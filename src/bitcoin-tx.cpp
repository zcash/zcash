...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("SodaToken sodatoken-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sodatoken-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sodatoken transaction") + "\n" +
              "  sodatoken-tx [options] -create [commands]   " + _("Create hex-encoded sodatoken transaction") + "\n" +
              "\n";
