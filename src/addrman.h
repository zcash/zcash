...
protected:
    ...
    //! Find an entry.
    CAddrInfo* Find(const CNetAddr& addr, int *pnId = NULL) EXCLUSIVE_LOCKS_REQUIRED(cs);
    ...
    void Attempt_(const CService &addr, int64_t nTime) EXCLUSIVE_LOCKS_REQUIRED(cs);
