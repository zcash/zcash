...
UniValue getrawtransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            ...
            "       \"valueSat\": n      (numeric, optional) The value of the output being spent, in " + MINOR_CURRENCY_UNIT + "\n"
            ...
            "       \"valueZat\" : n,             (numeric) The value in " + MINOR_CURRENCY_UNIT + "\n"
            "       \"valueSat\" : n,             (numeric) The value in " + MINOR_CURRENCY_UNIT + "\n"
            "       \"n\" : n,                    (numeric) index\n"
            ...
            "       \"vpub_oldZat\" : n,          (numeric) public input value in " + MINOR_CURRENCY_UNIT + "\n"
            "       \"vpub_new\" : x.xxx,         (numeric) public output value in " + CURRENCY_UNIT + "\n"
            "       \"vpub_newZat\" : n,          (numeric) public output value in " + MINOR_CURRENCY_UNIT + "\n"
...
UniValue createrawtransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\": x.xxx   (numeric, required) The key is the " PACKAGE_NAME " address, the value is the " + CURRENCY_UNIT + " amount\n"
            "      ,...\n"
            "    }\n"
