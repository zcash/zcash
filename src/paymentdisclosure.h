...
struct PaymentDisclosureInfo {
    ...
    uint256 esk;              // sodatoken/NoteEncryption.cpp
    ...
    PaymentDisclosureInfo(uint8_t v, uint256 esk, uint256 key, libsodatoken::PaymentAddress zaddr) : version(v), esk(esk), joinSplitPrivKey(key), zaddr(zaddr) { }
...
struct PaymentDisclosurePayload {
    ...
    libsodatoken::PaymentAddress zaddr; // sodatoken/Address.hpp
