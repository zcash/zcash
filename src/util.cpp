...
const char * const ZCASH_CONF_FILENAME = "zcash.conf";
const char * const ZCASH_PID_FILENAME = "zcashd.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Zcash";
#else
    // Unix
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", ZCASH_CONF_FILENAME));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No configuration file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override configuration filename
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", ZCASH_PID_FILENAME));
