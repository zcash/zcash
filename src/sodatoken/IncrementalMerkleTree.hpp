...
} // end namespace `libsodatoken`

typedef libsodatoken::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libsodatoken::SHA256Compress> ZCIncrementalMerkleTree;
typedef libsodatoken::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libsodatoken::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libsodatoken::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libsodatoken::SHA256Compress> ZCIncrementalWitness;
typedef libsodatoken::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libsodatoken::SHA256Compress> ZCTestingIncrementalWitness;
