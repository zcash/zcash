...
PARAMS_DIR="$HOME/.sodatoken-params"

SPROUT_PKEY_NAME='sprout-proving.key'
SPROUT_VKEY_NAME='sprout-verifying.key'
SPROUT_URL="https://sodatoken.org/downloads"
...
Failed to fetch the SodaToken zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
SodaToken - fetch-params.sh

This script will fetch the SodaToken zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common SodaToken zkSNARK parameters. Note that it is
